...
namespace handleFileCertificados.Controllers
{
    ...
    public class AsignacionController : ControllerBase
    {
        ...
        private const string keyName = "testing";
        private const string filePath = "";
        private static readonly RegionEndpoint bucketRegion = RegionEndpoint.USWest2;
        private readonly IAmazonS3 _s3Client;

        public AsignacionController(IAsignacionRepository asignacionRepository, IAmazonS3 s3Client)
        {
        ...
        {
            var inputFileName = @"C:\laragon\www\Onixcertisys\storage\app\public\documentos\excels\05-03-2021-SOFTWARE INDICADORES.xlsm";
            ...
            IWorksheet worksheet = workbook.Worksheets["hoja de trabajo"];
            ...
            var outputFile = new FileStream(@"C:\laragon\www\Onixcertisys\storage\app\public\documentos\excels\05-03-2021-SOFTWARE INDICADORES2.xlsm", FileMode.Create);
